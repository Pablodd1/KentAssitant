...
export default function CasesPage() {
    ...
    if (loading) {
        return (
            <div className="container mx-auto py-10 text-center flex flex-col items-center justify-center min-h-[50vh]" aria-live="polite">
                <Loader2 className="h-10 w-10 animate-spin text-blue-600 mb-4" />
                <p className="text-xl text-gray-600 font-medium">Loading patient cases...</p>
            </div>
        );
    }
                    ...
                    cases.map((c) => (
                        <div key={c.id} className="border p-6 rounded-lg flex justify-between items-center shadow-sm hover:shadow-md transition-shadow bg-white">
                            ...
                            <Link 
                                ...
                                className="bg-slate-900 text-white px-6 py-2 rounded-lg hover:bg-slate-700 transition-colors font-medium flex items-center gap-2"
                            >
                                <span>Open Case</span>
