...
export default function CasesPage() {
    ...
    if (loading) {
        return (
            <div className="container mx-auto py-10 text-center flex flex-col items-center justify-center min-h-[50vh]">
                <Loader2 className="animate-spin text-blue-600 mb-4" size={48} />
                <p className="text-xl font-medium text-gray-600">Loading cases...</p>
            </div>
        );
    }
